...
import com.mdb.example.administrator.fuwu.AddYouhuiquanActivity;
 ...
 * 我的管理优惠券界面
 */
public class YouhuiManager2Activity extends BaseActivity implements XListView.IXListViewListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharehelper = new SharedPreferencesHelper(YouhuiManager2Activity.this,"xicheshop");
        adapter = new YouhuiAdapter(YouhuiManager2Activity.this,arrayList);
        setTtitle();
        fanhui();
    ...
    private void setinfo() {
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sharehelper.put("youhuiquan","1");
                Intent intent = new Intent(YouhuiManager2Activity.this,AddYouhuiquanActivity.class);
    ...
    private void fanhui(){
        lfanhui.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                YouhuiManager2Activity.this.finish();
            }
        });
    }
...
//                        Log.e("优惠券",s);
    ...
    private void showTimer(final TextView editText){
        ...
        TimePickerView mTimePickerView = new TimePickerView(YouhuiManager2Activity.this, TimePickerView.Type.YEAR_MONTH_DAY);// 四种选择模式，年月日时分，年月日，时分，月日时分
        // 设置是否循环
