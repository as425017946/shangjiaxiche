 ...
 * 我的页面发布信息页面
 */
public class ReleaseProject2Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharehelper = new SharedPreferencesHelper(ReleaseProject2Activity.this,"xicheshop");
    ...
    private void setinfo() {
        ...
        img_suolv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(ReleaseProject2Activity.this);
                LayoutInflater inflater = LayoutInflater.from(ReleaseProject2Activity.this);
...
//                        a=1;
        ...
        img_yuyue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isyuyue="1";
                img_yuyue1.setImageDrawable(ReleaseProject2Activity.this.getResources().getDrawable(R.mipmap.radio1));
                img_yuyue2.setImageDrawable(ReleaseProject2Activity.this.getResources().getDrawable(R.mipmap.radio2));
        ...
        img_yuyue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isyuyue="0";
                img_yuyue1.setImageDrawable(ReleaseProject2Activity.this.getResources().getDrawable(R.mipmap.radio2));
                img_yuyue2.setImageDrawable(ReleaseProject2Activity.this.getResources().getDrawable(R.mipmap.radio1));
...
//                                        +"serviceNum"+edt_jiange.getText().toString()+"intervalTime"+edt_cheliang.getText().toString());
                                Bitmap bitmap = PhotoUtils.getBitmapFromUri(shwoimgsview, ReleaseProject2Activity.this);
                                if (bitmap!=null){
//                                    beginupload(shwoimgsview);
                                    if (isyuyue.equals("1")){
                                        if (TextUtils.isEmpty(edt_jiange.getText().toString())){
                                            ToastUtils.centerToast("请输入时间间隔");
                                        }else {
                                            if (Integer.parseInt(edt_jiange.getText().toString())>=20){
                                                if (TextUtils.isEmpty(edt_cheliang.getText().toString())){
                                                    ToastUtils.shortToast("请输入最大预约车数");
                                                }{
                                                    beginupload(shwoimgsview);
                                                }
                                            }else {
                                                ToastUtils.shortToast("输入的时间间隔不能小于20分钟");
                                            }
                                        }
    ...
    private void fanhui(){
        lfanhui.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ReleaseProject2Activity.this.finish();
            }
        });
    }
    //时间选择器
    private void showTimer(final TextView editText){
        ...
        TimePickerView mTimePickerView = new TimePickerView(ReleaseProject2Activity.this, TimePickerView.Type.HOURS_MINS);// 四种选择模式，年月日时分，年月日，时分，月日时分
        // 设置是否循环
...
//                Toast.makeText(context, format.format(date), Toast.LENGTH_SHORT).show();
    ...
    public void beginupload(Uri bitmap) {
        ...
        PutObjectRequest put = new PutObjectRequest(startpoint, objectname, UiUtils.getImageAbsolutePath(ReleaseProject2Activity.this,bitmap) );
        // 异步上传时可以设置进度回调
            ...
            OkGo.post(Api.fabuxinxi)
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(String s, Call call, Response response) {
                            ...
                            LoadingDailog.Builder loadBuilder=new LoadingDailog.Builder(ReleaseProject2Activity.this)
                                    .setMessage("信息提交中...")
                                    .setCancelable(false)
...
//                                        ToastUtils.shortToast("发布新信息成功");
            ...
            Log.e("时间间隔",Integer.parseInt(edt_jiange.getText().toString())+"");
            if (Integer.parseInt(edt_jiange.getText().toString())>=20){
                Log.e("时间间隔2",Integer.parseInt(edt_jiange.getText().toString())+"");
                OkGo.post(Api.fabuxinxi)
                        .tag(this)
                        .params("serviceName",spinnerzhi)
                        .params("serviceImg",zhiye)
...
//                                    ToastUtils.shortToast("发布新信息成功");
                ...
                Log.e("时间间隔3",Integer.parseInt(edt_jiange.getText().toString())+"");
                Toast.makeText(ReleaseProject2Activity.this,"时间间隔不能小于20分钟",Toast.LENGTH_SHORT).show();
